...
interface MainButtonProps {
  ...
  type?: "button" | "submit";
  className?: string;
  variant?: "gradient" | "white" | "outline" | "outlineBlack" | "red";
  disabled?: boolean;
  isLoading?: boolean;
  onClick?: () => void;
  loadingText?: string;
...
export default function MainButton({
  ...
  const variants = {
    ...
    red:
      "bg-accent border border-black text-white enabled:xl:hover:brightness-125 enabled:focus-visible:brightness-125",
  };
