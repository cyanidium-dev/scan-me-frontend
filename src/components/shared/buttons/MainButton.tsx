...
export default function MainButton({
    ...
    const variants = {
        ...
        white: "bg-white text-black enabled:xl:hover:bg-accent enabled:focus-visible:bg-accent",
        outline:
        ...
        red: "bg-accent border border-black text-white enabled:xl:hover:brightness-125 enabled:focus-visible:brightness-125",
        black: "bg-black text-white enabled:xl:hover:brightness-125 enabled:focus-visible:brightness-125",
    };
        ...
        >
            {variant === "gradient" ? (
                <div
                    ...
                    style={{
                        background:
                            "linear-gradient(90deg, #73131A 0%, #E74451 100%)",
                        padding: "1px",
                        WebkitMask:
