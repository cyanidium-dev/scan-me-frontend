...
export default function CameraPlusIcon({ className }: CameraPlusIconProps) {
    return (
        <svg width="65" height="65" viewBox="0 0 65 65" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} aria-label="camera plus icon">
            <path d="M40.625 35.2083H24.375" stroke="#FAFAFA" stroke-width="1.5" stroke-linecap="round" />
            <path d="M32.5 27.0833L32.5 43.3333" stroke="#FAFAFA" stroke-width="1.5" stroke-linecap="round" />
            ...
            <path d="M51.4583 27.0833H48.75" stroke="#FAFAFA" stroke-width="1.5" stroke-linecap="round" />
        </svg>
