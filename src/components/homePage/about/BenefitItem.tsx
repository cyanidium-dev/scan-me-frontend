...
export default function BenefitItem({ benefit }: BenefitItemProps) {
  ...
  return (
    <li className="flex flex-col justify-center items-center w-[calc(50%-6px)] lg:w-[calc(25%-18px)] min-h-[116px] p-2 lg:p-8 rounded-[16px] bg-accent last:bg-black lg:even:bg-accent lg:odd:bg-black text-white">
